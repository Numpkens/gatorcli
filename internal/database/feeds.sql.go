...
WITH inserted_feed_follow AS (
    ...
    -- FIX: Use sqlc.arg() to explicitly name the positional parameters
    VALUES ($1, $2, $3, $4, $5)
...
func (q *Queries) GetFeedFollowsForUser(ctx context.Context, dollar_1 uuid.NullUUID) ([]GetFeedFollowsForUserRow, error) {
	rows, err := q.db.QueryContext(ctx, getFeedFollowsForUser, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
